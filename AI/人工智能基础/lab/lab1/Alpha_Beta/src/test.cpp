...
int test(int index)
{
    ...
    std::string output_file = file_base + "output/output_" + std::to_string(index) + ".txt";
    ...
    alphaBeta(root, std::numeric_limits<int>::min(), std::numeric_limits<int>::max(), 5, true);
    ...
    output << cur_board[result.init_x][result.init_y] << " (" << result.init_x << "," << result.init_y << ") (" << result.next_x << "," << result.next_y << ")";
